        ...
        <Box sx={useStyles.section}>
          <Box sx={useStyles.root}>
            ...
            <Typography variant="body1" sx={useStyles.paragraph}>
              ...
              are added at the rear end and removed from the front. This
              behavior makes queues an essential tool for managing data in
              various scenarios, from task scheduling in operating systems to
              print job management and network packet processing. Understanding
              queues is crucial for efficient algorithm design and system
              development.
            </Typography>
          </Box>
          <Box sx={useStyles.root}>
            ...
            <Typography variant="body1" sx={useStyles.paragraph}>
              ...
              <ol>
                <li>
                  ...
                  <ul>
                    <li>
                      This operation adds a new element to the back (rear) of
                      the queue.
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      This operation removes the element from the front (head)
                    ...
                    <li>
                      ...
                      queue is empty before attempting a dequeue to avoid
                      errors.
                    </li>
                  </ul>
                </li>
              ...
              <Typography variant="body1">
                These two operations establish the FIFO order in a queue.
                Elements are added at the back and removed from the front,
                ensuring the first in line gets processed first.
              </Typography>
            </Typography>
          </Box>
          <Box sx={useStyles.root}>
